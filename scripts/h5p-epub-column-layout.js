H5P.EPubColumn = (function (EventDispatcher) {

  /**
   * EPubColumn Constructor
   *
   * @class
   ...
   */
  function EPubColumn(params, id, data) {
    /** @alias H5P.EPubColumn# */
    var self = this;
...
console.log(tasksResultEvent);
    ...
    var showSummary = function () {
      ...
      for (const inst of instances) {
        ...
        if (readOnlyActivities.includes(machineName)
            || (['H5P.InteractiveVideo', 'H5P.CoursePresentation'].includes(machineName) && !EPubColumn.isTask(inst))) {
          continue;
        }
              ...
              click: function () {
                ...
                H5P.jQuery('.submit-answers').remove();
                  ...
                  var confirmationDialog = new H5P.ConfirmationDialog({
                    headerText: 'EPubColumn Layout Summary',
    ...
    self.attach = function ($container) {
      ...
      setTimeout(() => {
        ...
        for (var i = 0; i < instances.length; i++) {
          if(EPubColumn.isTask(instances[i])) {
    ...
    /**
     * Get title, e.g. for xAPI when EPubColumn is subcontent.
     *
     * @return {string} Title.
     */
    self.getTitle = function () {
      return H5P.createTitle((self.contentData && self.contentData.metadata && self.contentData.metadata.title) ? self.contentData.metadata.title : 'EPubColumn');
    };
  ...
  EPubColumn.prototype = Object.create(EventDispatcher.prototype);
  EPubColumn.prototype.constructor = EPubColumn;
   ...
   * @return {boolean}
   */
  EPubColumn.isTask = function (instance) {
